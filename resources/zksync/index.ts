...
const config: IDAOConfig = {
  ...
  METATAGS: {
    ...
    IMAGE_DISCORD: 'https://zksync.karmahq.xyz/daos/zksync/preview-discord.png',
    IMAGE_TWITTER: 'https://zksync.karmahq.xyz/daos/zksync/preview-twitter.png',
    FAVICON: '/daos/zksync/favicon.ico',
    URL: `https://zksync.karmahq.xyz`,
  },
  DAO_CHAINS: [zkSync],
  ...
  DAO_EXT_VOTES_PROVIDER: {
    onChain: onChainZkSyncVotesProvider,
  },
...
const dark: IDAOTheme = {
  ...
  card: {
    ...
    text: { primary: '#FFFFFF', secondary: '#1854f4' },
