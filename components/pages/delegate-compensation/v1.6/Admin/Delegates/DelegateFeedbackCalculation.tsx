...
interface DelegateFeedbackCalculationProps {
  delegateFeedback: NonNullable<DelegateStatsFromAPI['stats']['delegateFeedback']>;
}

export const DelegateFeedbackCalculation = ({ delegateFeedback }: DelegateFeedbackCalculationProps) => {
  const {
    relevance = 0,
    depthOfAnalysis = 0,
    timing = 0,
