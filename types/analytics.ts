...
export const SUMMARY_TOOLTIPS = {
  ...
  averageVpUsagePercentage: "Average percentage of voting power used per week (0-100%)"
};
...
export const WEEKLY_METRICS_TOOLTIPS = {
  ...
  quorumAmount: "The minimum amount of voting power required for a proposal to be considered valid and pass",
  activeDelegates: "The number of delegates who have been active during the reporting period",
  votingPowerUsed: "The total amount of voting power that has been used across all proposals",
  totalVotes: "The total number of votes cast across all proposals",
  uniqueVoters: "The number of unique addresses that have participated in voting",
  activeProposals: "The number of proposals that are currently active and open for voting",
  vpUsagePercentage: "The percentage of total voting power that has been used in voting (0-100%)"
}; 